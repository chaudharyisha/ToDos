package com.code.springboot.todos.controller;
...
import com.code.springboot.todos.service.AuthenticationService;
...
public class AuthenticationController {
    ...
    @Operation(summary = "Login a user",description ="submit email & pasword to authenticate user" )
    @ResponseStatus(HttpStatus.OK)
    @PostMapping("/login")
    public AuthenticationResponse login(@Valid @RequestBody AuthenticationRequest authenticationRequest) throws IllegalAccessException {
